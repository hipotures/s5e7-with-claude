...
CHALLENGER_FILES = [
    os.path.join(SCORES_PATH, "subm-0.97582-20250706_040034-xgb-tc07.csv"),
    os.path.join(SCORES_PATH, "subm-0.97468-20250706_031620-xgb-tc07.csv"),
    os.path.join(SCORES_PATH, "subm-0.97538-20250706_032037-cat-tc07.csv"),
    os.path.join(SCORES_PATH, "subm-0.97479-20250706_031622-cat-tc07.csv"),
    os.path.join(SCORES_PATH, "subm-0.97576-20250706_035101-gbm-tc07.csv"),
    os.path.join(SCORES_PATH, "subm-0.97490-20250706_004053-gbm-tc04.csv"),
]
...
# Print the results
print("Analysis of Submission Disagreements (Corrected Baseline)")
print("=========================================================")
...
output_path = os.path.join(SCORES_PATH, "disagreement_analysis_corrected.csv")
