...
def objective_xgboost(trial, X, y, cv_folds=5):
    """Optuna objective dla XGBoost z GPU"""
    ...
    for fold, (train_idx, val_idx) in enumerate(cv.split(X, y)):
        ...
        # Pruning callback
        pruning_callback = XGBoostPruningCallback(trial, f'validation_{fold}_mlogloss')
...
def main():
    ...
    train_df, test_df = analyzer.prepare_data('../../train.csv', '../../test.csv')
    ...
    # XGBoost z najlepszymi parametrami
